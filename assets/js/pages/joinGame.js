...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  let authReady = false;
  try { await waitForAuth(); authReady = true; } catch (err) { console.error('Auth failed:', err); }
  ...
  joinCodeInput.addEventListener('keydown', e => { if (e.key === 'Enter') joinGameBtn.click(); });
